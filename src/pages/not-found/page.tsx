          ...
          <div className="flex flex-col items-center max-w-sm mx-auto text-center nunito-sans-regular gap-y-4">
            ...
            <div className="flex items-center w-full gap-x-3 shrink-0 sm:w-auto">
              <Button
                ...
                onClick={() => navigate(-1)}
                className={cn(
                  "flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700 font-medium border-slate-200",
                )}
              >
              ...
              <Button
                asChild
                className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primary rounded-lg shrink-0 sm:w-auto hover:bg-primary/90 font-medium"
              >
